  ...
  <div class="container-fluid"> 
    ...
    <div class="collapse navbar-collapse" id="defaultNavbar1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="active"><a href="developer.jsp">제작자 정보<span class="sr-only">(current)</span></a></li>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
      <h1 class="text-center">개발자 정보</h1>
    </div>
  </div>
  <hr>
</div>
<div class="container">
  <div class="row text-left">
	  <div class="col-md-6 col-md-offset-3 col-lg-offset-0 col-lg-12">정민넷은 개발자인 김은우와 양인규가 합작해서 만들어 졌습니다.</div>
	  <div class="col-md-6 col-md-offset-3 col-lg-offset-0 col-lg-12"><i>추가예정 </i></div>
  </div>
</div>
<hr>
<div class="row">
